...
public class SadMovieFinder implements IMovieFinder {
    ...
    public List<Movie> findAll() {
        ...
        movie = new Movie("The Shawshank Redemption - Modified", releaseDate, "Darabont", Movie.Genre.DRAMA);
        movies.add(movie);
        ...
        movie = new Movie("Schindler's List - Modified", releaseDate, "Spielberg", Movie.Genre.DRAMA);
        movies.add(movie);
